...
class p2SelectionScene: SKScene
{
    ...
    let p1fourth: String
     ...
     init(size:CGSize, p1school: Int, p2school: Int, p1firsty: String, p1secondy: String, p1thirdy: String, p1fourthy: String)
    {
    ...
    func goToGameScene() {
        ...
        let transitionEffect = SKTransition.doorsCloseHorizontalWithDuration(1)
        let scene = GameScene(size: CGSize(width: 640 * aspectRatio, height: 640), player1school: p1schoool, player2school: p2schoool, p1first: p1first, p1second: p1second, p1third: p1third, p1fourth: p1fourth, p2first: firstSelection.text!, p2second: secondSelection.text!, p2third: thirdSelection.text!, p2fourth: fourthSelection.text!)
        let skView = self.view! as SKView
        skView.showsFPS = true
        skView.showsNodeCount = true
        skView.ignoresSiblingOrder = true
        scene.scaleMode = .AspectFill
        skView.presentScene(scene, transition: transitionEffect)
    }
